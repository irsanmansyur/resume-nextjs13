...
import TechStackWithIcons from '@/components/TechStackWithIcons';
  ...
  return (
    <>
      <section className="container relative mb-10">
        <div className="flex md:items-center md:justify-between gap-4 min-h-screen pt-20 ">
          ...
          <div className="hidden md:flex items-center  w-1/2 -mx-4 overflow-hidden justify-center">
